...
#import "SSAlbumTableViewController.h"
#import "Album.h"

@interface SSAlbumTableViewController () <UIAlertViewDelegate>

@end

@implementation SSAlbumTableViewController
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 1) {
        ...
        [self.tableView insertRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:[self.albums count] inSection:0]] withRowAnimation:UITableViewRowAnimationFade];
    }
}
